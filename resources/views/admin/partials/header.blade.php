        ...
        <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item dropdown user-menu">
                <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                    <!-- Auth::user() no upyog karine dynamic name lakhvu -->
                    <span class="d-none d-md-inline">{{ Auth::user()->name }}</span>
                </a>
                <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                    <!-- User Image -->
                    <li class="user-header text-bg-primary">
                        <img src="./assets/img/user2-160x160.jpg" class="shadow rounded-circle" alt="User Image" />
                        <p>
                    ...
                    <!-- Menu Footer: D-Flex vapryu che jethi buttons ek line ma rahe -->
                    <li class="p-3 user-footer d-flex justify-content-between align-items-center">
                        {{-- <a href="{{ route('users.index') }}" class="btn btn-outline-primary btn-flat">Profile</a> --}}
