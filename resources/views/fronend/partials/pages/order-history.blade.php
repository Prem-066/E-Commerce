                ...
                <div class="col-md-2 col-sm-6 text-end mob-text-center">
                    ...
                    <div class="d-flex justify-content-md-end justify-content-center align-items-center mt-2">
                        ...
                        <a href="{{ route('invoice.download', $order->id) }}"
                            class="btn btn-outline-success btn-sm fw-bold px-2 me-2" style="border-radius: 20px;">
                            ...
                            <table class="table table-borderless align-middle">
                                ...
                                <tbody>
                                    ...
                                    <tr class="border-bottom-sm">
                                        ...
                                        @php
                                        $days = $item->return_policy_days ?? 7;
                                        $deliveryDate = $item->delivered_at;
                                        $canReturn = false;
                                        if ($deliveryDate && !in_array($item->status, ['Returned', 'Cancelled'])) {
                                        $lastReturnDate = \Carbon\Carbon::parse($deliveryDate)->addDays($days);
                                        if (now()->lessThan($lastReturnDate)) {
                                        $canReturn = true;
                                        }
                                        }
                                        @endphp
                                        <td class="text-center action-column">
                                            ...
                                            @elseif($canReturn)
                                            <button onclick="changeItemStatus({{ $item->id }}, 'Returned')"
                                                class="btn btn-sm btn-outline-secondary">Return</button>
                                            @endif
                                        </td>
